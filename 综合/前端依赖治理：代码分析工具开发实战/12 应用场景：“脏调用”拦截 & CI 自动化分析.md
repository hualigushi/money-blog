代码分析工具的应用场景有很多，这一节课我们主要从 `依赖调用方` 角度出发，学习如何实现 **“脏调用”拦截** 和 **CI自动化分析，** 本节课讲解的的代码示例都在 [code-demo](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fliangxin199045%2Fcode-demo) 下，建议 clone 到本地对照学习。

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/10c34beeecb44e2dad5d5c73300c3216~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6828212fd5d74bb78e2c7fa33b9ed9f0~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
我们一般不会手动去改 `.git/hooks` 里面的文件，可以通过工具来完成这些操作，比如 [pre-commit](https://link.juejin.cn/?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Fpre-commit)、 [husky](https://link.juejin.cn/?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Fhusky)、 [git-scripts](https://link.juejin.cn/?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Fgit-scripts) 等工具都可以帮助开发者添加 git hook，这里我们以 pre-commit 为例：
...
上面的 package.json 信息来自 [code-demo](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fliangxin199045%2Fcode-demo) 项目，执行 npm install 就会安装相应的 `git hook`，然后提交更改会触发下图的 `hook` 拦截效果：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/63526585aec646c5a77b6df8b59df4bf~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ee0f83640dfb41f2a4411fecece51bc7~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

从 CI 流水线任务执行的结果来看，`work` 任务失败了，可以点击下面的 `work` 任务查看任务流水日志：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e7b226ceeba34df392a511c55a676711~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8010701bb05a4b899d163253ef838c1d~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d8e2c850294a484fa1bc9fd949996d89~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

（ps：图上所示网址只是一个例子，code-demo 的分析报告可以看 [这里](https://link.juejin.cn/?target=https%3A%2F%2Fliangxin199045.github.io%2Fcode-demo%2F)）
...
推送报告的 shell 脚本示例，[notification.sh](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fliangxin199045%2Fcode-demo%2Fblob%2Fmain%2Fnotification.sh) ：
...
代码告警的 shell 脚本示例，[alert.sh](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fliangxin199045%2Fcode-demo%2Fblob%2Fmain%2Falert.sh) ：
...
然后我们完善一下 [.gitlab-ci.yml](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fliangxin199045%2Fcode-demo%2Fblob%2Fmain%2F.gitlab-ci.yml) 文件：
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/752371b63ee64fe38986a3a9dc744141~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

定时任务触发后的任务页面演示（示例）：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a667282efb784ca8ac04c8f1ebd5648d~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

分析任务顺利完成，会推送包含报告URL的消息，点击地址就可以查看 [在线报告](https://link.juejin.cn/?target=https%3A%2F%2Fliangxin199045.github.io%2Fcode-demo%2F) 了（示例）：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/490a280a2f884656b73d6211c791df13~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ed5e0557a6eb4054a9fbd19faab1cf2b~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

如果分析时触发代码告警，则推送告警消息，开发者点击URL可以打开任务流水日志定位问题（示例）：

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dc2b275a2b0c47a5a441740170fdc8bb~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
3. 通过创建定时任务来触发 `gitLab CI` 的 `pipeline`，可以实现 CI 自动化分析。
