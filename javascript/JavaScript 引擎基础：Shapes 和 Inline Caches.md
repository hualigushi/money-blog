...
![img](https://pic3.zhimg.com/80/v2-49e43b1e5022aa384690a868cf78b25a_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-1b61f44bb9e4a057c6df42c271855a66_720w.jpg)

这个通用流程几乎与在 Chrome 和 Node.js 中使用的 V8 引擎工作流程一致：

![img](https://pic4.zhimg.com/80/v2-aa915fa00f0d90f0887deb72d394c37f_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-8bbb94363eba210503592366926a8dc2_720w.jpg)

SpiderMonkey，在 Firefox 和 [SpiderNode](https://link.zhihu.com/?target=https%3A//github.com/mozilla/spidernode) 中使用的 Mozilla 的 JavaScript 引擎，则有一些不同的地方。它们有两个优化编译器。解释器将代码解释给 Baseline 编译器，该编译器可以生成部分优化的代码。 结合运行代码时收集的分析数据，IonMonkey 编译器可以生成高度优化的代码。 如果尝试优化失败，IonMonkey 将回退到 Baseline 阶段的代码。

![img](https://pic2.zhimg.com/80/v2-6a75e96542175b4c162f36988db765fd_720w.jpg)

Chakra，用于 Edge 和 [Node-ChakraCore](https://link.zhihu.com/?target=https%3A//github.com/nodejs/node-chakracore) 两个项目的微软 JavaScript 引擎，也有类似两个优化编译器的设置。解释器将代码优化成 SimpleJIT——其中 JIT 代表 Just-In-Time 编译器——它可以生成部分优化的代码。 结合分析数据，FullJIT 可以生成更深入优化的代码。

![img](https://pic1.zhimg.com/80/v2-2ee3ede4c7814a8ce49f86f544ddf61c_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-32f00f136e7e30937fd1040ed023b29a_720w.jpg)
...
你可以将数组想象成一组特殊的对象。两者的一个区别便是数组会对数组索引进行特殊的处理。这里所指的数组索引是 ECMAScript 规范中的一个特殊术语。在 JavaScript 中，数组被限制最多只能拥有2^32-1项。数组索引是指该限制内的任何有效索引，即从0到2^32-2的任何整数。
...
![img](https://pic4.zhimg.com/80/v2-baf55c8d7b820c29827b45ed0e220eff_720w.jpg)

`'length'` 属性恰好是另一个不可枚举且不可配置的属性。

一个元素一旦被添加到数组中，JavaScript 便会自动更新 `'length'` 属性的 `[[Value]]` 属性值。

![img](https://pic3.zhimg.com/80/v2-049a3873fbb33b0db4f2a71e5a62990e_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-dcf04944ff026b188741259af2467def_720w.jpg)
...
![img](https://pic1.zhimg.com/80/v2-f492f67ab0e8151300f5262e7c4b87d0_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-3ab3fd33251f4fed283861aa66b9d246_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-743364415ff10a493c3a710354ed8b71_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-23b8f8d78d5956292a679dbd4ad18b11_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-966d8fb75d391973e2725837f2c4c211_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-1a7c2a7962391fb7a87e311f0d188f87_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-d6cfbd3b93af81474356762ac9d34549_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-9b6a76dc428ed8f97d616e6256a0762d_720w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-aa64bb9cd77685c2e9f299b4f9da580d_720w.jpg)

嵌入到 `get_by_id` 指令中的 IC 存储该属性的 shape 和偏移量：

![img](https://pic4.zhimg.com/80/v2-0a97de17acb9ecbe7f4da5322f6a141f_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-0419d2aa300938554a498d7a1df0614f_720w.jpg)

这与我们之前见过的类似……但数组值存储在哪里呢？

![img](https://pic3.zhimg.com/80/v2-2fafd71a573106a258fe52b138d84602_720w.jpg)
...
![img](https://pic4.zhimg.com/80/v2-23494c295a06d0c2e9ab374503f8c547_720w.jpg)
