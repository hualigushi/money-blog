[基于vue的h5文件切片上传（获取文件md5，实现秒传、进度条实现）](https://blog.csdn.net/qq_42245281/article/details/81263303)

[结合element-ui 的el-upload组件支持分片上传](https://juejin.im/post/5b9b6e81f265da0ab2281ae0)

[字节跳动面试官：请你实现一个大文件上传和断点续传](https://juejin.im/post/5dff8a26e51d4558105420ed#heading-26)

[写给新手前端的各种文件上传攻略，从小图片到大文件断点续传](https://juejin.im/post/5da14778f265da5bb628e590#heading-25)

[原生JS Uploader基础类](https://github.com/impeiran/Blog/tree/master/uploader)
