...
最初是为了提升代码抽象能力，避免人为DOM操作，降低代码风险
...
- 内存占用较高：当前网页的虚拟DOM包含了真实DOM的完整信息，而且是Object，其内存占用肯定会有所上升
...
虚拟DOM相对原生的DOM不一定是效率更高，如果只修改一个按钮的文案，那么虚拟 DOM 的操作无论如何都不可能比真实的 DOM 操作更快。
